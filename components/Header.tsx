...
const Header: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-40 bg-slate-900/60 backdrop-blur-lg shadow-lg sm:rounded-t-lg">
      {/* Shipping Banner */}
      <div className="text-center py-2 px-4 sm:px-6">
        <p className="text-xs sm:text-sm font-semibold text-green-400 uppercase tracking-widest">
          {tPricing.shipping}
        </p>
      </div>
